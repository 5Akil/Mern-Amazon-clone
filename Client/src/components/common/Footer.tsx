                ...
                <div className="bottom">
                    <div className="center">
                        <ul>
                            ...
                            <li><a href="#">Prime Now<br /><span>FREE 2-Hour Delievery<br /> on Everyday Items</span></a></li>
                        </ul>
                        <ul>
                            ...
                            <li><a href="#">Fabr/ic<br /><span>Sewing, Quilting<br /> &amp; Knitting</span></a></li>
                        ...
                        <ul>
                            <li><a href="#">6pm<br /><span>Score deals<br /> on fashion br/ands</span></a></li>
                            <li><a href="#">Home Services<br /><span>Handpicked Po<br /> Happiness Guarantee</span></a></li>
                            <li><a href="#">Book Depository<br /><span>Books With Free<br /> Delievery Worldwide</span></a></li>
                            <li><a href="#">Goodreads<br /><span>Book reviews<br /> &amp; recommendations</span></a></li>
                            <li><a href="#">Shopbop<br /><span>Designer<br /> Fashion Br/ands</span></a></li>
                        ...
                        <ul>
                            ...
                            <li><a href="#">IMDb<br /><span>Movies, TV<br /> &amp; Celebr/ities</span></a></li>
                            <li><a href="#">TenMarks.com<br /><span>Math Activities<br /> for Kids &am; Schools</span></a></li>
                        ...
                        <ul>
                            ...
                            <li><a href="#">Amazon Restaurants<br /><span>Food delivery from<br /> Local Restaurant</span></a></li>
                        ...
                        <ul className="copy text-center">
                            ...
                            <li><a href="#">Interest-Based Ads</a></li><br />
                            <li>&copy 1996-2022, Amazon.com, Inc. or its affiliates</li>
                        </ul>
                    </div>
                </div>
